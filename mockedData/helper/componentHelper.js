...
const fixtures = {
	...
	actionGrid: [
		{ url: 'ActionGridFull', response: actionGrid[camelize(req.params.type)]() },
	...
	actionList: [
		{ url: 'ActionListFull', response: actionList[camelize(req.params.type)]() },
	...
	donutChart: [
		{ url: 'DonutChartFull', response: donutChart[camelize(req.params.type)]() },
	...
	columnChart: [
		{ url: 'ColumnChartFull', response: columnChart[camelize(req.params.type)]() },
	...
	combinationChart: [
		{ url: 'CombinationChartFull', response: combinationChart[camelize(req.params.type)]() },
	...
	dataTable: [
		{ url: 'DataTableFull', response: dataTable[camelize(req.params.type)]() },
	...
	heatMap: [
		{ url: 'HeatMapFull', response: heatMap[camelize(req.params.type)]() },
		{ url: 'HeatMapEmptyData', response: heatMap.emptyData() },
		{ url: 'HeatMapTabbed', response: heatMap.tabbed() },
	],
	simpleLineChart: [
		{ url: 'SimpleLineChartFull', response: simpleLineChart[camelize(req.params.type)]() },
	...
	simpleList: [
		{ url: 'SimpleListFull', response: simpleList[camelize(req.params.type)]() },
	...
	stackedColumnChart: [
		{ url: 'StackedColumnChartFull', response: stackedColumnChart[camelize(req.params.type)]() },
