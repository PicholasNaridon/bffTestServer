		...
		content: [
			{
				listItems: [
					...
					{
						employeeName: { title: 'A Very Fake Name' },
						'In Progress': { title: 'Hello!' },
						Completed: { title: 0 },
						'Under Review': { title : 40 },
					},
				],
				title: 'Training Plans',
				columnTitles: ['employeeName', 'In Progress', 'Completed', 'Under Review'],
...
function oneTab() {
	return {
		tagName: 'cmp-action-grid',
		subtitle: 'One tab, shows that buttons can go in any column',
		content: [
			{
				listItems: [
					{
		...
		content: [
			{
				...
				columnTitles: ['employeeName', 'In Progress', 'Completed'],
				diveLink: { url: 'https://elevate.flqa.net/reports/summative-report', text: 'View Report' },
				options: {
					hideFirstColumnTitle: true,
					showBands: true,
